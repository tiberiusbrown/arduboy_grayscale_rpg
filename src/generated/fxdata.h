...
constexpr uint24_t FX_DATA_BYTES = 410764;
...
constexpr uint24_t PORTRAIT_STRINGS = 0x062E70;
constexpr uint24_t GAME_OVER_MESSAGES = 0x062F9C;
constexpr uint24_t STRINGDATA = 0x0633B9;
