...
constexpr uint16_t FX_DATA_PAGE  = 0xfac9;
constexpr uint24_t FX_DATA_BYTES = 341732;
...
constexpr uint24_t ITEM_STRINGS = 0x053038;
constexpr uint24_t PORTRAIT_STRINGS = 0x0535B8;
