...
constexpr uint24_t FX_DATA_BYTES = 549188;
...
constexpr uint24_t SONG_TITLE = 0x074290;
constexpr uint24_t SONG_PEACEFUL = 0x07777A;
constexpr uint24_t SONG_PEACEFUL2 = 0x079223;
constexpr uint24_t SONG_DUNGEON = 0x07B3E8;
constexpr uint24_t SONG_VICTORY = 0x07CA67;
constexpr uint24_t SONG_DEFEAT = 0x07CB5E;
constexpr uint24_t SONG_BATTLE = 0x080306;
constexpr uint24_t ITEM_INFO = 0x082B8C;
constexpr uint24_t PORTRAIT_STRINGS = 0x08424E;
constexpr uint24_t GAME_OVER_MESSAGES = 0x08438E;
constexpr uint24_t STRINGDATA = 0x08489E;
constexpr uint24_t FX_IDENTIFIER_B = 0x08613C;
