...
constexpr uint16_t FX_DATA_PAGE  = 0xfac5;
constexpr uint24_t FX_DATA_BYTES = 342669;
...
constexpr uint24_t ITEM_STRINGS = 0x0533E1;
constexpr uint24_t PORTRAIT_STRINGS = 0x053961;
