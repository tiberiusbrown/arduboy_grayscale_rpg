...
constexpr uint16_t FX_DATA_PAGE  = 0xfad0;
constexpr uint24_t FX_DATA_BYTES = 339846;
...
constexpr uint24_t GAME_OVER_MESSAGES = 0x051FED;
constexpr uint24_t STRINGDATA = 0x05231D;
constexpr uint24_t ITEM_STRINGS = 0x0528DA;
constexpr uint24_t PORTRAIT_STRINGS = 0x052E5A;
