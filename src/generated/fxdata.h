...
constexpr uint24_t FX_DATA_BYTES = 410335;
...
constexpr uint24_t PORTRAIT_STRINGS = 0x062DB6;
constexpr uint24_t GAME_OVER_MESSAGES = 0x062EE2;
constexpr uint24_t STRINGDATA = 0x0632AE;
