...
constexpr uint16_t FX_DATA_PAGE  = 0xfac6;
constexpr uint24_t FX_DATA_BYTES = 342347;
...
constexpr uint24_t ITEM_STRINGS = 0x05329F;
constexpr uint24_t PORTRAIT_STRINGS = 0x05381F;
