...
constexpr uint16_t FX_DATA_PAGE  = 0xf79d;
constexpr uint24_t FX_DATA_BYTES = 549630;
...
constexpr uint24_t SFX_CHATTER = 0x074316;
constexpr uint24_t SFX_DAMAGE = 0x0743FA;
constexpr uint24_t SFX_ITEM = 0x07440A;
constexpr uint24_t SONG_TITLE = 0x07444A;
constexpr uint24_t SONG_PEACEFUL = 0x077934;
constexpr uint24_t SONG_PEACEFUL2 = 0x0793DD;
constexpr uint24_t SONG_DUNGEON = 0x07B5A2;
constexpr uint24_t SONG_VICTORY = 0x07CC21;
constexpr uint24_t SONG_DEFEAT = 0x07CD18;
constexpr uint24_t SONG_BATTLE = 0x0804C0;
constexpr uint24_t ITEM_INFO = 0x082D46;
constexpr uint24_t PORTRAIT_STRINGS = 0x084408;
constexpr uint24_t GAME_OVER_MESSAGES = 0x084548;
constexpr uint24_t STRINGDATA = 0x084A58;
constexpr uint24_t FX_IDENTIFIER_B = 0x0862F6;
