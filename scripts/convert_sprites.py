...
convert(BINBASE + 'options_img.bin', '', 'options.png', 128, 16)
convert(BINBASE + 'options_bottom_img.bin', '', 'options_bottom.png', 128, 32)
convert(BINBASE + 'options_sound_img.bin', '', 'options_sound.png', 70, 16)
convert(BINBASE + 'options_sound_opts_img.bin', '', 'options_sound_opts.png', 27, 8)
